...
../drawio-ultra/scripts/layout_geometry.py. The result uses a top-left
...
Run:
    ...
    python ../drawio-ultra/scripts/layout_geometry.py layout.json \
...
apply the result:
    ...
    python ../drawio-ultra/scripts/apply_layout.py diagram.excalidraw \
      layout.result.json
    python ../drawio-ultra/scripts/apply_layout.py diagram.drawio \
